...
// App Module: the name Sheikhstore matches the ng-app attribute in the main <html> tag
// the route provides parses the URL and injects the appropriate partial page

var storeApp = angular.module('Sheikhstore', ['ngRoute', 'ngAnimate', 'initialValue']).
...
storeApp.controller('postController', function ($scope, $http) {
    ...
    $scope.submitForm = function (contactform) {
        ...
        var myCart = new shoppingCart("SheikhStore");
...
//    myCart.addCheckoutParameters("PayPal", "sadkilele@gmail.com");
    myCart.addCheckoutParameters("PayPal", "sadkilele@gmail.com");
